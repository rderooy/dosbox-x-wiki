...
DOSBox-X will show the drop-down menus in the windowed mode by default, but you can also hide it if you prefer, using any of the following ways:

* Start with the -nomenu command-line option;

* Under the "Video" menu, select "Hide/show menu bar" when the menu bar is visible;
