...
#### Keyboard shortcuts:
By default the following keyboard shortcuts, specific to CGA are available:
...
It's intended purpose was the display of KANJI DBCS (Double Byte Character Set) which required a higher resolution, as such this added a 640x480 video mode.
...
* link:https://en.wikipedia.org/wiki/AX_architecture[Wikipedia article on AX]
