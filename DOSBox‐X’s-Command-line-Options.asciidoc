...
* **-startui** or **-startgui**
+
Starts DOSBox-X with its Configuration GUI interface, where you can review or change its settings.
* **-startmapper**
+
Starts DOSBox-X and enters to the keyboard mapper editor directly, where you can change DOSBox-X’s key mappings.
* **-showcycles**
+
