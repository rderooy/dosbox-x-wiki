...
* **Support for cue sheets with FLAC, MP3, WAV, OGG and OPUS CD audio tracks**
+
With DOSBox-X it is possible to mount .cue files that include FLAC, MP3, WAV, OGG Vorbis and OPUS music as CD audio tracks.
