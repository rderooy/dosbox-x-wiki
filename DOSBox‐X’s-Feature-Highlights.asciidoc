...
* **Support for complete customization of Virtual Drive Z:**
+
DOSBox-X allows you to freely customize the internal virtual drive Z:, including adding your own files to the Z drive, or hiding/replacing existing files on the Z drive, with directory support.
