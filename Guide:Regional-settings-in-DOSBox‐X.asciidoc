...
This is a list of keyboard layouts that can be used in DOSBox, and by extension DOSBox-X. For layouts marked with * you must have ten ega.cpx files (from FreeDOS) in the DOSBox-X directory.
...
|kk|Kazakhstan*
|ky|Kyrgyzstan*
|la171 (la)|atin-American-Spanish
|lv, lv455|Latvia*
