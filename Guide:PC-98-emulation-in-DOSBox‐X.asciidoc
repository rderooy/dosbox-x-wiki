...
Assuming you have the HDI images for these Touhou games, you can use a mount them as the C drive and then either boot from the drive or start the game directory. For example:
