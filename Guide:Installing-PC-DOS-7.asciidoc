...
Note: This method requires us to work around a bug, for which you need to use the ```SYS``` to transfer the system files before running the SETUP program. This requires DOSBox-X 0.83.2 or newer.
....
