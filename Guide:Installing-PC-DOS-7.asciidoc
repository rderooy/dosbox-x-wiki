...
Note: This method requires us to work around a bug, for which you need to manually copy IBMBIO.COM and IBMDOS.COM files before running the SETUP program.
....
