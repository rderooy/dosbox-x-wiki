...
# Enabling networking
To enable networking you first need to enable NE2000 adapter emulation in your winme.conf file and select an appropriate back-end for the NE2000 emulation.
