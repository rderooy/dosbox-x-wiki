...
2. You can also set the reported DOS version with the ``VER`` command in the DOSBox-X command line. For example, ``VER SET 6.22`` will cause DOSBox-X to claim to be version 6.22. Also note that "VER SET 7.1" will set the reported DOS version to  7.1 (7.10) whereas "VER SET 7 1" will set the reported DOS version to 7.01.
