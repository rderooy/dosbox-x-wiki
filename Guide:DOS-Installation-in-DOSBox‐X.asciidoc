...
2. You can also set the reported DOS version with the ``VER`` command in the DOSBox-X command line. For example, ``VER SET 6.22`` will cause DOSBox-X to claim to be version 6.22.
