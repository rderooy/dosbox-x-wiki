...
### Setup permissions
First of all, we need to ensure that the DOSBox-X binary has permission to listen to and generate low level network traffic. You can do this as follows:
...
You can merge your config snippet with your Windows for Workgroups, Windows 95 or 98 config file, or just run something like mTCP in DOSBox-X.
