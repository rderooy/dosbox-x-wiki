...
NOTE: There are also the *Roland GS* extensions to General Midi, as used on the Roland Sound Canvas devices like the SC-55 and SC-88.
...
The Roland SC-55 or SC-88 (Sound Canvas), were used by many musicians back in the day to compose General MIDI music for DOS and Windows games.
