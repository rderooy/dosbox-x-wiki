...
Note that clipboard copying and pasting using mouse buttons or arrow keys is not available for the Linux/macOS SDL1 builds.
...
Note: This function was only available for the Windows platform in DOSBox-X version 0.83.10 and earlier. In version 0.83.11 and later it is available for Linux/macOS builds also, although in Linux/macOS SDL1 builds only read access is supported.
...
Note: This function was only available for the Windows platform in DOSBox-X version 0.83.10 and earlier. In version 0.83.11 and later it is available for Linux/macOS builds also, although in Linux/macOS SDL1 builds only text pasting is supported.
