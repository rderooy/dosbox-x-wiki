...
Copy or rename the games original GLIDE2X.OVL to something like GLIDE2X.ORG, and copy the GLIDE2X.OVL from the Z: drive to the game directory, replacing the games original GLIDE2X.OVL.
...
instructions needed... Which glide2x.dll implementation? Glidos, DgVoodoo, nGlide or OpenGlide?
