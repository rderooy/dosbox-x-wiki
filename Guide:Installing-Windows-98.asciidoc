...
This is an example of a 8GB (8192 MB) disk.
....
IMGMAKE hdd.img -size 8192
....
...
This installation method allows both FAT16 (up to 2GB) and FAT32 volumes, which can be up to 2TB (tested up to 700GB).
