...
For Windows 98, select any Colour PostScript printer such as the "QMS ColorScript 100 Model 30", during printer setup connected to LPT1.
...
For Windows 98, select the "Epson LQ-860+" option during printer setup connected to LPT1
