...
# Enabling networking
To enable networking you first need to enable NE2000 adapter emulation in your win98.conf file and select an appropriate back-end for the NE2000 emulation.

## Enabling NE2000 in your DOSBox-X config file

DOSBox-X supports two different back-ends to the NE2000 adapter emulation.
...
As such it will work with WIFI, WAN and BT adapters, and it will work in sandboxed environments.
