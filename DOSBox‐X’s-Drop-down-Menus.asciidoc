...
DOSBox-X features a GUI menu bar that does not exist in DOSBox, so you can achieve many things from the menu without typing commands. There are 7 drop-down menus shown in DOSBox-X’s menu bar, namely "Main", "CPU", "Video", "Sound", "DOS", "Capture" and "Drive".
