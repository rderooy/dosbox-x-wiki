...
First you need to mount the C drive again.
....
IMGMOUNT 2 hdd.img -size 512,63,130,1023 -fs none
....
...
Once the format is completed, you need to reset the guest operating system again, such that your back at the DOSBox-X ```Z:\``` prompt.
