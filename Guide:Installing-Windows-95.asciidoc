...
* This method will result in a C: drive using FAT16. If you want a FAT32 C: drive, follow Method 2.
...
* If you want to have your C: drive as FAT32, which allows volumes greater then 2GB, you need to have a MS-DOS 7.1 boot disk with the corresponding FDISK and FORMAT utilities.
* You need to have at least *Windows 95 OSR2*, as older releases lack FAT32 support.

## Windows boot disk
This process requires a suitable Windows 95 OSR2 (or later) installation boot disk image. Getting such an image file is outside the scope of this guide.
