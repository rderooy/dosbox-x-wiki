...
There is a newer S3 video driver for Win95, version link:https://vogonsdrivers.com/getfile.php?fileid=1325&menustate=0[2.41.07], dated Dec 17, 1997.
...
The only known solution for now if you used an older driver is to re-install Win95 and use the 2.41.07 driver instead.
