...
* If using Windows 95 OSR2 with FAT32 volumes, be sure to change the DOS version to 7.1 or else you will get errors mounting the FAT32 volume
...
This is an example of a 8000MB disk.
....
IMGMAKE hdd.img -t hd -size 8000
....
