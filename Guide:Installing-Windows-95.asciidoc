...
* While Windows 95 should support up to 2048MB RAM, ``memsize=480`` is the largest safe value. Larger values may be poissible with tweaks, bbut are not covered here.
