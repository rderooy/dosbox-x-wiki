...
If you boot DOS as a guest OS, you will also need to load the CuteMouse driver v2.1 as such: `CTM-EN /O`, and make sure no other mouse drivers are being loaded in the `AUTOEXEC.BAT` file.
