...
* **Quick launch program...** Launch a program selected from the Windows file browser to run inside DOSBox-X directly. The program folder will be automatically mounted and unmounted, with the option to stay in the program folder after the program finishes.
...
* **Select save slot**: Select a save slot (1-100) to save to or load from. There are 10 pages for save slots, with 10 save slots in each page.
