...
* link:DOSBox%E2%80%90X’s-Drop%E2%80%90Down-Menus[DOSBox‐X’s Drop-Down Menus]
+
...
* link:DOSBox‐X’s-Command%E2%80%90Line-Options[DOSBox-X's Command-Line Options]
+
