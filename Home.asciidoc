...
* link:Guide%3ASelecting-a-video-adapter-in-DOSBox‐X{suffixappend}[Guide: Selecting a video adapter in DOSBox-X]
+
Explains about the different video modes as supported in DOSBox-X.
* link:Guide%3ASelecting-an-audio-option-in-DOSBox‐X{suffixappend}[Guide: Selecting an audio option in DOSBox-X]
+
