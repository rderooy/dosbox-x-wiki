...
# Overview
DOSBox-X has support for emulating the Novell NE2000 network adapter, and this guide describes how to set it up and and also tries to simplify the process for users.
