...
By default ISO-9660 Level 1 is used. When emulating DOS version 7.0 or later (or `lfn=true` in the DOSBox-X config file), ISO-9660 Level 2 is supported with up to 31 character filenames.
