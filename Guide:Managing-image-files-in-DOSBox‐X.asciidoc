...
- Rock Ridge extensions to ISO-9660, allowing up to 255 character file names (typically used by Unix or Unix-like systems, such as Linux)
- Joliet extensions to ISO-9660, allowing up to 64 character file names (introduced for Windows 95)
