...
You can optionally specify the ``-o partidx=0`` parameter, where 0 needs to be replaced by the partition you want to mount.
Zero is the same as not specifying the parameter as it represents the first primary partition.
