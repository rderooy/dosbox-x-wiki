...
- Rock Ridge extensions to ISO-9660 (typically used by Unix systems, such as Linux)
- Joliet extensions to ISO-9660 (64 character long file names, introduced for Windows 95)
- UDF filesystem (introduced for Windows 98)
...
Starting with DOSBox-X 0.84.2, there is support for the Rock Ridge and Joliet extensions to the ISO-9660 filesystem, in addition to support for the UDF filesystem.
