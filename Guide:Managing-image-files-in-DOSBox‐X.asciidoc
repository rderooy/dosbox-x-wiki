...
They are junk and have a high likelihood of damaging your disk.
...
* Mention windows ``IMGMOUNT`` -bat option.
* How about IDE teriary through octenary controllers in dosbox-x config. Do the device ID and/or -ide options continue counting up to ID 18 and ``-ide 8s``?
