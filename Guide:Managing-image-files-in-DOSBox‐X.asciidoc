...
They can also be used when mounting multiple diskette images. If you use the -ro option, then all images specified in the command will become read-only. On the other hand, if you wish to make individual images (instead of all of them) read-only then you can attach the ``:`` prefix to these images, like this:
....
