...
+
Usage: UTF8 [/BE|/LE] < [drive:][path]filename or command-name | UTF8 [/BE|/LE]
+
Note: The /BE and /LE options enable the UTF-16 BE/LE (instead of UTF-8) conversions respectively. 
