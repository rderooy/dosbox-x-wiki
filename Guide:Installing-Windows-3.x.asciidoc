...
Next in Windows 3.x, select any Epson dot-matrix printer such as:

- For Windows 3.0, the "Epson LQ-850/950/1050" option during printer setup connected to LPT1
- For Windows 3.1x, the "Epson LQ-860" option during printer setup connected to LPT1
