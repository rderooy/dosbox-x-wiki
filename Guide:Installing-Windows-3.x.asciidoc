...
NOTE: If you intend to use Video for Windows (VFW), first install VFW and then the updated S3 video driver. Alternatively, reinstall the S3 video driver after installing CFW. Failing to do so will result in VFW playback giving a green window.
