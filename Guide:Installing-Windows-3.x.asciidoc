...
* link:https://nerdlypleasures.blogspot.com/2016/12/windows-30-multimedia-edition-early.html[Windows 3.0 Multimedia Edition install guide]
...
You can also not mount a host directory (folder mount) in DOSBox-X when you boot a disk image.
...
NOTE: In the case of Windows 3.0 with Multimedia Extensions, the driver shipped with the Tandy and Creative Labs CD-ROM upgrade kits works best with the SB Pro 1 emulation.
The sound driver for this is included with the Windows installation.
...
The same can be carried out with *Windows 3.0a with Multimedia Extensions*, but no option similar to the above "SB16 All MIDI" option will not be listed.
