...
* This edition available only to OEMs, as such they will be customized to the systems it was shipped with.
Examples of such customization, are an OEM specific launcher, but also that the installer may default to custom audio and video options.
