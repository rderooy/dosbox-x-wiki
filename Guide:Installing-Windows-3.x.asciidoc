...
You do not have to enter anything for Description. |image::images/Windows:Windows_3.0_MIDI_1.png[Windows 3.0a MIDI]
...
Once finished click the "OK" button and confirm the save. |image::images/Windows:Windows_3.0_MIDI_2.png[Windows 3.0a MIDI, 600]
|===
