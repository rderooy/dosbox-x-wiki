...
|===
a|In Windows 3.1x go to "Control Panel", and open "MIDI Mapper.
If there is no "MIDI Mapper" icon in "Control Panel", the Sound Blaster drivers were not installed.
Select the "SB16 All MIDI" option from the drop-down menu, and press the "Close" button. a|image::images/Windows:Windows_3.1_MIDI.png[Windows 3.1x MIDI]
|===
...
|===
a|Instead in the "MIDI Mapper" dialog box click on the "New..." button.
...
You do not have to enter anything for Description. a|image::images/Windows:Windows_3.0_MIDI_1.png[Windows 3.0a MIDI]
a|You will then get a "MIDI Setup" window.
...
Once finished click the "OK" button and confirm the save. a|image::images/Windows:Windows_3.0_MIDI_2.png[Windows 3.0a MIDI, 600]
|===
